...
class SignUp3 extends GetView<ServiceTypeController> {
...
Obx((){
          return controller.isLoading.isFalse?Form(
  ...
  },
  {
   ...
   {
    'value': controller.rs[4],
    'display': Get.locale!.languageCode=='ar'? controller.rs[4].label_ar:Get.locale!.languageCode=='fr'?controller.rs[4].label_fr:Get.locale!.languageCode=='en'? controller.rs[4].label:'en',
  ...
  onChanged: (val) =>{controller.smartPhone= val},
  onSaved: (val) => {},
),
    SizedBox(
                height: 25,
  ...
  onChanged: (val) => { controller.statusSelected= val },
  onSaved: (val) => {}
),
    SizedBox(
                height: 25,
  ...
  onChanged: (val) =>{controller.senioritySelected= val},
  onSaved: (val) => {},
),
    SizedBox(
                height: 25,
  ...
  onChanged: (val) => {controller.cooptedSelected= val},
