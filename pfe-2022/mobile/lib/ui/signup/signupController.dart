...
findServiceType()async{
  print("*********test ***************");
 isLoading(true);
 rs= await serviceType.findServiceType();
...
ls= await langageService.findLangage();
 ...
 cooptedList = [
  {
    'value': cs[3].id,
    'label':Get.locale!.languageCode=='ar'? cs[3].label_ar:Get.locale!.languageCode=='fr'?cs[3].label_fr:Get.locale!.languageCode=='en'? cs[3].label:'en',
...
s= await seniorityService.findseniority();
  ...
  },
  {
  ...
  },
   {
    ...
    {
    'value': s[4].id,
     'label':Get.locale!.languageCode=='ar'? s[4].label_ar:Get.locale!.languageCode=='fr'?s[4].label_fr:Get.locale!.languageCode=='en'? s[4].label:'en',
     'textStyle': TextStyle(color: Colors.black),
    ...
    if (isValid) {
      ...
      print(s);
       print(senior);
        ...
        mou3ina.serviceType= selectedValues;
        mou3ina.langageSpeaking = selectedValuess;
        await createMou3ina();
        print("success");
         print(mou3ina);
        }else{ print("failed");}
