...
import com.sofrecom.operation.admin.dao.CustomerOrderMou3inaListRepository;
import com.sofrecom.operation.admin.entities.*;
import com.sofrecom.operation.admin.dao.CustomerReservationRepository;
import com.sofrecom.operation.admin.service.ICustomerReservation;
...
public class CustomerReservationcontroller {
    ...
    public CustomerReservation  createCustomerReservation(@PathVariable Long id,@RequestBody CustomerReservation CustomerReservation) {
      ...
      //  CustomerOrderMou3inaListId pk = new CustomerOrderMou3inaListId(order.getId(), m.getId());
        ...
        CustomerReservation.setCustomerOrderMou3inaLists((Set<com.sofrecom.operation.admin.entities.CustomerOrderMou3inaList>) CustomerOrderMou3inaList);
