...
public class InterviewController{
    ...
    public Interview addInterview(@PathVariable Long id,@RequestBody Interview m) throws FirebaseMessagingException {
    ...
    public Interview updateInterview(@PathVariable Long id, @RequestBody Interview p) throws FirebaseMessagingException {
        p.setId(id);
