...
public class AvailibilitiesMou3ina {
	...
	public AvailibilitiesMou3ina(Long id, Date created_at, Date date, boolean morning, boolean evening, boolean afternoon, com.sofrecom.operation.customer.entities.Mou3inaEntity mou3inaEntity) {
		this.id = id;
		this.created_at = created_at;
		this.date = date;
		this.morning = morning;
