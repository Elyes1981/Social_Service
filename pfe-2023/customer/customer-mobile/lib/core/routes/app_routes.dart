...
import '../../ui/notificationPresence/MessageScreenPresence.dart';
import '../../ui/notificationPresence/notificationPresence.ui.dart';
...
class AppRoutes {
  ...
  static final List<GetPage<Widget>> routes = <GetPage<Widget>>[
    ...
    GetPage<MessageScreenPresence>(
        name: dispo,
        page: () => MessageScreenPresence(),
        transition: Transition.upToDown,
        preventDuplicates: true,
        opaque: false,
        curve: Curves.fastLinearToSlowEaseIn),
