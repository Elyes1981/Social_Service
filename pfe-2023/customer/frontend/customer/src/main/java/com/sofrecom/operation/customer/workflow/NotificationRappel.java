...
public class NotificationRappel implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        firebaseService.sendNotification("notification de rappel pour le provider", customerReservation.getId()+"", "f-c_xqujSsayobXIZAXZt-:APA91bGVllRxmegJopnbsr9qPLKWJbJgTCjTHCgY8ADD3aYTP909nog60Db3dotM9MwL7WilnFTlePTYXfUHAhJvAQ4CfyZEd-pPYsGFDNG8874JBol-eCu6V_I-P33XBFeq0WUx35wG");
